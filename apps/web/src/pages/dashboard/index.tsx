          ...
          <div className="mt-4 select-none rounded-md border border-zinc-200 bg-zinc-50 p-5">
            <div className="flex w-full flex-row gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-zinc-600">
                  This is a development version of the app, so some features may
                  not work as expected. If you find any bugs, please report them
                  on the GitHub issues of the project.
                </p>
              </div>
            </div>
          </div>
